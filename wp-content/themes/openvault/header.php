...
<div id="main-container" class="hfeed container">
  ...
  <div class="row">
    <div class="span3">
      ...
      <div class="span9">
        <div id="search-bar">
    <form accept-charset="UTF-8" action="<?php echo get_option('openvault_url') ?>/catalog" class="search-query-form form-inline clearfix" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="✓"></div>
      ...
      <form accept-charset="UTF-8" action="<?php echo get_option('openvault_url') ?>/catalog" class="categories" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="✓" style="display: none;"></div>
  ...
  <optgroup label="Categories"><option value="category-1">Category 1</option></optgroup></select>
      ...
      <form accept-charset="UTF-8" action="<?php echo get_option('openvault_url') ?>/catalog" class="collections" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="✓" style="display: none;"></div>
